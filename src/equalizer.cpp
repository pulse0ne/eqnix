...
///////////////////////
    ...
    /////
    g_object_set(nodes[0], "frequency", 50.0, "q", 1.0, "emitfr", TRUE, "frbands", 5, nullptr);
    /////
    ...
    std::thread([](GstElement* n) {
        ...
        g_print("here\n");
        g_object_set(n, "gain", 8.0, nullptr);
    }, nodes[0]).detach();
    ...
    // g_object_set(band, "freq", 10.0, "gain", -10.0, "bandwidth", 10.0, "type", 0, nullptr);
}
